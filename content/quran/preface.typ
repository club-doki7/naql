...
本书是一部汉语《古兰经》译注合编本，旨在为中文读者提供一份兼顾经文翻译与经注解读的参考文本。以下就翻译底本、经注选择及附加内容作简要说明。

== 经文翻译

经文翻译以马坚先生的译本为底本。马坚译本是中文世界流传最广、影响最大的《古兰经》汉译本之一，其译笔忠实、文辞典雅，至今仍是许多中文读者接触《古兰经》的首选。

在此基础上，本书对部分字形作了规范化调整，将旧字形改为现行通用字形，如"於"改为"于"、"後"改为"后"等，以便当代读者阅读。此外，参照穆罕默德·素莱曼译本以及马坚先生本人在后续版本中所作的增补，对个别措辞进行了修订。例如，将"天神"改为"天使"等，以求译名的准确与统一。

== 经注选择

本书的经注部分取材于三部经典注释著作，各有侧重：

- *Tazkirul Quran*（毛拉纳·瓦希杜丁·坎著）：作为经注的主体。该经注以深入浅出、面向现代读者的风格见长，着重阐释《古兰经》的核心精神与思想内涵，引导读者在理性层面理解经义。
- *Tafsir Ibn Ashur*（伊本·阿舒尔著，节选）：用作每章的导读。伊本·阿舒尔的经注以学术严谨著称，对每章的主旨思想、降示语境、名称由来及经文总览等提供了详尽的考述，有助于读者在研读各章之前建立整体的认知框架。
- *Ma'arif al-Quran*（穆夫提·穆罕默德·沙菲著，节选）：用于解释评注一些关键事项的教法细节。该经注在教法阐释方面尤为详尽。本书在涉及律法、功修等具体规定时酌情援引其论述，但并不旨在穷尽所有教法判断。

这些经注部分皆由英文译本转译而来，并对照乌尔都语 / 阿拉伯语原文进行修正。

== 译注与问答

除上述三部经注外，本书还在必要处添加了译注，以补充历史背景、语境说明或译者的学习心得，帮助读者理解经文中可能造成困惑之处。

此外，本书收录了部分来自 quran.com 的问答内容。这些问答以简明扼要的形式，针对读者在阅读经文时可能产生的常见疑问给出解答，是对经注的有益补充。

#v(2em)

#align(right)[
  译者 Chuigda Whitegive

  Doki Doki #sym.lambda Club!#sym.trademark / 心跳演算部！#sym.trademark

  #image("../assets/DokiSeven-Red.svg", width: 64pt)
]
...
#quote(block: true, attribution: "7:172")[
  [Prophet], when your Lord brought forth the offspring from the loins of the Children of Adam and made them bear witness about themselves, He said, "Am I not your Lord?" and they replied, "Yes, we bear witness that You are." So you cannot say on the Day of resurrection, "We were not aware of this."
]

In the following verse, the Quran makes further mention of the dialogue between God and man:

#quote(block: true, attribution: "33:72")[
  Surely We offered Our trust to the heavens and the earth, and the hills, but they shrank from bearing it and were afraid of it. And man undertook it. But he has proved a tyrant and a fool.
]
...
== Jihad is _a Peaceful Ideological Struggle_

Those who are introduced to the Quran only through the media, generally have the impression that the Quran is a book of _jihad_, and _jihad_ to them is an attempt to achieve one's goal by means of violence. But this idea is based on a misunderstanding. Anyone who reads the Quran for himself will easily appreciate that its message has nothing to do with violence. The Quran is, from beginning to end, a book which promulgates peace and in no way countenances violence. It is true that _jihad_ is one of the teachings of the Quran. But _jihad_, taken in its correct sense, is the name of peaceful struggle rather than of any kind of violent action. The Quranic concept of jihad is expressed in the following verse, "Do greater _jihad_ (i.e strive more strenuously) with the help of this [Quran]" (25:52).
...
《古兰经》是真主的经典，其完整性永远受到保护。它虽以阿拉伯语写成，但借助译本，不通阿拉伯语的人也得以接触。译文固然无法替代原文，却在将真主的话语从阿拉伯语世界传向更广大的人群方面，发挥了重大的作用。

《古兰经》表面上是阿拉伯语，实质上却使用的是"自然的语言"——即造物主在创世之初直接向全人类宣告时所用的语言。这一神圣的召唤始终存在于每个人的意识之中，因此《古兰经》具有普世的可理解性——对一些人是在意识层面，对另一些人则是在潜意识层面。《古兰经》将这一事实描述为"明显的迹象，保存在学者的胸中"，并接着说"只有不义的人否认我的迹象"（29:49）。

这意味着，《古兰经》在意识层面阐明的神圣真理，早已以潜意识的形式存在于人的内心。因此，《古兰经》的信息对人而言并非陌生之物，它实际上是那同一神圣真理的语言表达——这真理与人的本性相契合，人对它本已并不陌生。《古兰经》对此的解释是：后世出生的人类灵魂，在阿丹被造之初便已存在，彼时真主曾直接向所有这些灵魂宣告。
...
在以下经文中，《古兰经》进一步提及了真主与人类之间的对话：

#quote(block: true, attribution: "33:72")[
  我确已将重任信托天地和山岳，但它们不肯承担它，它们畏惧它，而人却承担了——人确是不义的，确是无知的。
]

对人而言，《古兰经》本质上是他已知之物，而非全然未知的存在。实际上，《古兰经》是人类心灵的展开。

当一个天性灵动之人——即保全了自身本性、未被后天熏染所蒙蔽的人——诵读《古兰经》时，那些储存着造物主最初启示的脑细胞便会被激活。如果我们记住这一点，就不难理解：通过译文来理解《古兰经》，是一种切实可行的途径。

如果说真主的启示是"第一盟约"，那么《古兰经》就是"第二盟约"。二者互相印证。即便一个人对阿拉伯语所知甚少甚至一无所知，只能通过译文阅读经典，也不必担心自己无法理解《古兰经》——因为《古兰经》关于人是真主话语之天然接收者的理念，已在现代得到了验证。遗传密码学和人类学的研究成果都充分支持这一观点。

== 造物主的创世计划

每本书都有其主旨，《古兰经》的主旨是让人认识造物主的创世计划。也就是说，告诉人：真主为何创造了这个世界；将人安置于大地之上的目的是什么；在人死前的生命中被要求做什么；以及死后将面临什么。

人被造为永恒的存在。真主在如此造人时，将人的生命划分为两个阶段：死前的阶段是考验期，死后的阶段则是根据生前行为接受赏罚的时期——或是永恒的天园，或是永恒的火狱。《古兰经》的目的就是让人认识这一现实。这是这部神圣经典的主题，它引导人走过从今世到后世的全部旅程。

可以这样说：人天生就是一个探寻者。每个人心中都潜藏着这些问题：我是谁？我生命的目的是什么？生与死的真相是什么？人成功与失败的秘密是什么？……依据《古兰经》，这些问题的答案是：今世是考场，人在死前所被赋予的一切都是考验的一部分。后世是清算之地，人在死后所获得的赏罚，都与他在今世的行为相应。人在今世成功的秘诀，就是理解真主的创世计划，并据此规划自己的人生。

== 神圣警示之书

《古兰经》是一部神圣的警示之书。它融教训与劝诫于一体，称其为一部智慧之书或许更为恰当。《古兰经》并不遵循传统教科书的编排模式。事实上，普通读者拿起《古兰经》时，往往觉得它是一些零散段落的汇编。表面上看，这种感觉不无道理。但《古兰经》之所以如此编排，并非出于某种缺陷，而是有意保留其原始形式，以便实现其传达真理的使命——读者在翻阅经典时，哪怕每次只读一页、一节或一行，都能有所收获。

《古兰经》的一个重要方面是，它提醒人们至高施恩者所赐予的恩典。其中最重要的，是真主在造人时赋予人的卓越品质。另一大恩典是，他将人安置在地球上——这颗星球上存在着各种为人服务的支持系统。《古兰经》的目的是确保人在享受自然恩典的同时不忘施恩者：人必须感念造物主的慷慨。如此，人才能进入永恒的天园；反之，忽视施恩者则会将人径直引向火狱。《古兰经》正是对这一不可回避之现实的提醒。

有人认为，理解《古兰经》必须有一位已觉悟之人在场指引，即唯有借助精神导师的帮助，《古兰经》的含义才能被揭示。这是对人和《古兰经》的双重低估。《古兰经》诉诸人的理智，而理智是人最伟大的才能。因此，在纯粹的理性层面发现《古兰经》，就足以把握其含义。的确，在理性层面上，《古兰经》是一本敞开的书。但那些在更低层面上接触《古兰经》的人，不能说他们真正发现了它。他们转而依赖社群传统来寻求教导和启迪，这与《古兰经》始终倡导的理想宗教态度相比，根本无法同日而语。

== 内在精神与认主

《古兰经》的一个重要特质是：它只给出基本而关键的原则，并常以反复重申来加以强调。相反，非基本内容或仅涉及形式的事项，在经文中只占极少篇幅。这与《古兰经》的整体方案一致——形式的重要性完全是次要的。对《古兰经》而言，唯有那些具有根本指导意义的教诲才是重要的。《古兰经》的这一面向非常清晰，读者不可能不注意到它。

真正重要的是：内在精神在伊斯兰人格的塑造中至关重要。一旦内在精神得到培育，正确的形式自然随之而来。但徒有形式却永远无法产生内在精神。正因如此，《古兰经》的目标是在人的内心发起并促成一场思想革命。《古兰经》用以描述这场思想革命的术语是 _ma'rifah_（认识真理）（5:83）。

《古兰经》强调人在"认识"的层面上发现真理的重要性。真正的信仰就是在这一层面上获得的。没有认识，就没有信仰。

== 真主的言辞

当你阅读《古兰经》时，你会反复看到它声明自身是真主的言辞。表面上这只是一个简单的事实，但放在语境中看，却是一个非同寻常的声明。世上有许多被视为神圣的典籍，但除了《古兰经》之外，我们找不到任何一本宗教典籍如此自我宣示为真主的言辞。这种独一无二地出现在《古兰经》中的声明，为读者提供了一个全新的出发点。于是他将其作为一部非凡之书来研读，而非当作人类所撰写的普通著作。我们在《古兰经》中反复看到如下措辞的陈述："人啊，是你的主在对你讲话，聆听他的话语并追随他吧。"即便这种表达方式也非同寻常。这种直接的神圣召唤在其他任何典籍中都不存在。它给人留下深刻的印象。人感到他的主在直接对他说话。这种感受促使人以极其严肃的态度对待《古兰经》的声明，而不是将它们当作普通书中的日常文字。《古兰经》的编纂方式也独具一格。人类所写的书通常按主题从头到尾有序编排，但《古兰经》并不遵循这种模式，因此在普通人看来似乎缺乏条理。但若深入审视，就会发现它是一部极其连贯、有序且文风雄浑的经典。阅读《古兰经》时，我们感到它的作者站在极高之处，俯瞰并向全人类——他最为关切的对象——发出呼唤。这一宣告针对不同的人群，却将所有人涵盖其中。

《古兰经》的一个特别之处在于：读者在任何时刻都可以向它的作者请教、提出问题并获得回答——因为《古兰经》的作者就是真主本身。他是永活的主。作为人的造物主，他直接倾听并回应人的呼唤。

== 吉哈德 (_jihad_) 是和平的思想斗争

那些仅通过媒体接触《古兰经》的人，通常会以为《古兰经》是一本关于吉哈德 (_Jihad_) 的书，而"吉哈德"在他们看来就是以暴力手段实现目标的企图。但这种看法是基于误解的。任何亲自阅读《古兰经》的人都会很容易地认识到：经文的信息与暴力毫无关系。《古兰经》从始至终都是一本倡导和平的经典，绝不纵容暴力。诚然，吉哈德是《古兰经》的教导之一，但正确理解的"吉哈德"是和平奋斗的名称，而非任何形式的暴力行为。《古兰经》中关于吉哈德的理念体现在如下经文中："所以你不要顺从不信道者，你应当借此《古兰经》而与他们努力奋斗"（25:52）。

显然，《古兰经》不是武器，而是一部向我们介绍和平奋斗之神圣理念的经典。依据《古兰经》，这种奋斗的方式是"对他们说惊心动魄的话"（4:63）。

因此，依据《古兰经》所期望的方式，是一种触动人心智的方式——即在诉诸人的理智时令其信服，使其确信《古兰经》的真实性，简言之，在人的内心引发一场思想革命。这就是《古兰经》的使命，而这一使命只能通过理性论证来完成，绝不可能通过暴力或武装行动来实现。

诚然，《古兰经》中确有某些经文传达了类似以下的指令："你们在那里发现他们，就在那里杀戮他们"（2:191）。

针对这些经文，有人试图给人留下伊斯兰是一个战争与暴力宗教的印象。这完全不符合事实。这些经文仅在有限意义上涉及那些单方面攻击穆斯林的人。上述经文并非伊斯兰的一般性命令。

事实的真相是：《古兰经》并非以今天这样完整的形式一次性降示，而是在二十三年间根据具体情境分段降示的。如果将这段时期按战争与和平年份划分，和平时期长达二十年，而战争状态仅为三年。这二十年和平岁月中的启示，正是伊斯兰和平教导的内容——如认主、礼拜、道德、公正等方面的经文。

这种将命令区分为不同类别的做法是自然的，见于所有宗教典籍。例如，印度教的圣典《薄伽梵歌》涉及智慧和道德价值，但其中也有克利须那勉励阿周那上阵杀敌的劝导（《薄伽梵歌》3:30）。这并不意味着信奉《薄伽梵歌》的人应该不断发动战争。毕竟，圣雄甘地正是从同一部《薄伽梵歌》中得出了他的非暴力哲学。《薄伽梵歌》中关于战争的劝导仅适用于别无选择的特殊情况，而在日常生活中，它给出的正是甘地所汲取的那些和平教诲。

类似地，耶稣基督说过#footnote[此处英文原文如此。但根据历史学家的考证、基督教的一些内部讨论以及伊斯兰神学的普遍观点，四福音书并不全是对尔撒圣人言行的忠实记录，其中有许多编辑者假借尔撒圣人之名进行的创作。]："你们不要想我来是叫地上太平，我来并不是叫地上太平，乃是叫地上动刀兵。"（《马太福音》10:34）

由此断定基督所传的宗教是战争与暴力的宗教，是不正确的——因为这些话纯粹与特定场合有关。至于一般的生活，基督所教导的是和平的价值：培养良好品格、彼此相爱、帮助贫穷和有需要的人，等等。

《古兰经》亦是如此。当先知穆罕默德从麦加迁徙到麦地那时，偶像崇拜的部落对他充满敌意。但先知始终以忍耐和回避策略化解他们的进攻。然而在某些场合，除了自卫别无他法，因此他不得不在某些时候进行战斗。正是这些情势催生了与战争相关的启示。这些命令针对的是特定的情境，并不具有普遍适用性，也不是要永远有效。正因如此，先知的永恒地位被称为"全世界的慈悯"（21:107）。

伊斯兰是最完整意义上的和平宗教。《古兰经》称其道路为"平安的道路"（5:16）。它说和解是最好的方针（4:128），并声明真主厌恶任何对和平的破坏（2:205）。可以毫不夸张地说，伊斯兰与暴力是相互矛盾的。"伊斯兰暴力"这一概念如此明显地站不住脚，以至于初看便可驳斥。事实上，暴力在当今世界不可持续，这本身就足以说明暴力作为一种原则与伊斯兰的方案格格不入。伊斯兰自称是永恒的宗教，因此绝不可能支持任何经不起时间考验的原则。任何将暴力与伊斯兰挂钩的企图，等于是对伊斯兰宗教之永恒性的质疑。"伊斯兰恐怖主义"是一个自相矛盾的说法，犹如"和平主义恐怖主义"一样荒谬#footnote[事实上，“伊斯兰” (Islam) 的本意就是“和平、顺服”。]。而事实真相是：伊斯兰的全部教导，都直接或间接地建立在和平原则之上。

== 天启之书

《古兰经》是真主降示给先知穆罕默德的经典。它并非以今日所见的完整形式一次性降临，而是在二十三年间分段降示。最初的部分于公元 610 年降示，当时先知穆罕默德在麦加。此后，不同内容持续有序地降示，最后的部分于公元 632 年降示，彼时先知已在麦地那。

《古兰经》共有一百一十四章，有长有短。经文约六千六百节。为便于诵读，《古兰经》被分为三十卷。这些部分的最终编排，是在天使吉卜利勒的指导下完成的——真主正是通过他降示了《古兰经》。

《古兰经》在公元七世纪第一个二十五年降示时，造纸术已经发明。这种纸被称为莎草纸，由特定树木的纤维手工制成。每当《古兰经》的某一部分降示，便被记录在莎草纸上，阿拉伯语称之为 _qirtas_（6:7）。在此过程中,人们同时将经文背诵记忆——《古兰经》是唯一既在礼拜中诵读、又被用于宣教 (_da'wah_) 的伊斯兰经典。如此，《古兰经》便在记忆与书写中同步传承。这种保存方式贯穿了先知穆罕默德的一生。

第三任哈里发奥斯曼·本·阿凡令人制作了数份抄本，将它们分送至各城市，安放在大清真寺中。人们不仅从这些抄本中诵读，还据此制作了更多的副本。

手抄《古兰经》的传统一直延续到印刷术的发明和工业革命带来的大规模造纸。此后，《古兰经》开始被付梓印刷。印刷技术不断进步，《古兰经》的印刷质量也随之提升。如今，印刷版《古兰经》已极为普及，在每个家庭、清真寺、图书馆和书店都能找到。今天，无论身处世界何处，任何人都能获得一部精美的《古兰经》。
...
#table(
  ...
  [570], [先知穆罕默德诞生（其父在他出生前数月已去世）],
  [576], [先知之母阿米娜去世，时先知年仅六岁],
  [578], [先知的祖父阿卜杜·穆塔里卜去世],
  [595], [先知与赫蒂彻结婚],
  [610], [先知在麦加附近的努尔山上接受了《古兰经》的第一次启示],
  [613], [首次公开传教],
  [615], [部分圣门弟子迁往阿比西尼亚（埃塞俄比亚），以躲避麦加人的迫害],
  [616-619], [巴努·哈希姆族抵制先知及其家族],
  [619], [先知的妻子赫蒂彻和叔父艾布·塔里卜相继去世],
  [619], [先知前往塔伊夫寻求支持，却遭到当地人的侮辱],
  [620], [先知夜行至耶路撒冷，随后登霄至七重天],
  [622], [先知从麦加迁徙 (_hijrah_) 至麦地那，此事件标志着伊斯兰历的起点],
  [624], [白德尔之战：麦加的多神教徒被穆斯林击败],
  [625], [吴侯德之战：穆斯林被麦加的多神教徒击败],
  [628], [侯代比亚和约。与麦加的多神教徒缔结十年停战协定，使伊斯兰得以和平传播。许多人因此皈依伊斯兰],
  [630], [麦加的多神教徒违反停战协定。麦加和平归降——先知宽恕了麦加人，全城居民皈依伊斯兰],
  [631], ["使团之年"——阿拉伯各部落接受伊斯兰。先知与基督教徒及犹太教徒各部落缔结和约],
  [632], [先知的辞朝——最后一次前往麦加朝觐],
  [632], [6 月 8 日，先知穆罕默德在麦地那归真],
  [633], [第一任哈里发艾布·伯克尔主持将《古兰经》汇编成册],
  [645], [第三任哈里发奥斯曼令人制作数份《古兰经》抄本，分发至各地],
  [1153], [《古兰经》首次被译为拉丁文],
  [1543], [《古兰经》首次付梓印刷，由马丁·路德作序],
  [1649], [亚历山大·罗斯将《古兰经》从法文转译为英文],
  [1734], [乔治·塞尔的《古兰经》英译本],
  [1930], [穆罕默德·马默杜克·皮克索尔的《古兰经》英译本],
  [1934], [阿卜杜拉·优素福·阿里的《古兰经》英译本],
  [1980], [穆罕默德·阿萨德的《古兰经》英译本],
)
